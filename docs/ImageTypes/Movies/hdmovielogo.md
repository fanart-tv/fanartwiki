...
* A limit of 4 logos per movie per user. No Exceptions.
...
??? example "HD ClearLogo Templates and Tutorials"
    ...
    - [Photoshop HD ClearLogo Template](https://fanart.tv/wp-content/uploads/2014/01/HD-Logo-Template.rar/)
    - [ClearLogo Tutorials](https://fanart.tv/type/clearlogo/){target= blank}{target= blank}